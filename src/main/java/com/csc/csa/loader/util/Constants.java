...
public static String relationRole="RelationRole";
public static String clientID="ClientID";
public static String clientType="ClientType";
public static String genderId="GenderId";
public static String govID="GovID";
public static String searchDob="SearchDob";
public static String searchLastName="SearchLastName";
public static String suffix="Suffix";
public static String searchFirstName="SearchFirstName";
public static String searchMiddleName="SearchMiddleName";
public static String fullName="FullName";
public static String noOfAddress="NoOfAddress";

public static String LN1="Ln1";
public static String LN2="Ln2";
public static String LN3="Ln3";
public static String LN4="Ln4";
public static String COUNTRY="Country";
public static String STATE="State";
public static String ZIP="Zip";
public static String CITY="City";
public static String ADDR_TYPE="Type";
public static String ADDR_PREFIX="Add";
public static String ADDR1_TYPE="Add1Type";
public static String ERROR_FILE_LOCATION="c:/optBatchLogs/errorLog.txt";
public static String UPDATE_OPERATION="U";
public static String UPDATE_BY="DBLoader2";
public static String PARTY_TYPE="partyType";
public static String AGENT_NUMBER="agentNumber";
public static String AGENT_NUMBER_LONG="agentNumberLong";
public static String OPERATION_FLAG="OperationFlag";
public static String PLAN_NAME="plan";
public static String groupBilling="GroupBilling";//Added new field GroupBilling Charger1501
public static String productKey ="ProductKey";//Added new field GroupBilling Charger1501

public static String EXTRACT_TYPE="extractType";
public static String AGENT_EXTRACT="AGENT_EXTRACT";
public static String POLICY_EXTRACT="POLICY_EXTRACT";
...
public static final String FILE_NAME_POSTFIX="_PolicyFullExtrac";
public static final String BLANK="";


public static String AGENT_STATUS="agentStatus";
public static String AUDIT_LOGGER="com.csc.fsg.audit";
...
//CSCOPT-1985 public static final String PORT_RETRIEVE_ON_CLIENTID_SQL = "SELECT count(*) FROM CLIENT.PORTFOLIO where client_id in ( ";
...
/**
 * PANFRM-2424 
 * fetch number of row in uniA Database based on agentNumber and contractId
 */
